...
echo "WARNING - Path $path does not exist!" > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
...
echo "WARNING - Path $path is NOT Correct!" > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
