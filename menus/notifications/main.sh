...
case $CHOICE in
        B)
                ...
                --backtitle "Visit https://PlexGuide.com - Automations Made Simple" \
                --inputbox "USER KEY - WINDOWS USERS: CTRL+INSERT:" 8 45 2>/opt/appdata/plexguide/pushuser
                ...
                --backtitle "Visit https://PlexGuide.com - Automations Made Simple" \
                --inputbox "APP KEY - WINDOWS USERS: CTRL+INSERT:" 8 45 2>/opt/appdata/plexguide/pushapp
