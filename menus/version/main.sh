...
#
#################################################################################
echo 'INFO - @PG Version Selection Menu' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
...
if [ -e "$file" ]
then
echo "INFO - Ansible Detected" > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
else
echo "INFO - Ansible Not Detected - Installing" > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
...
echo 'INFO - Selected: Exit Upgrade Menu' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
            exit 0
            ;;
        01)
            ...
            echo "INFO - Selected: Upgrade to PG EDGE" > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
            echo ""
...
clear
echo 'INFO - Selected Not To Upgrade PG' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
...
echo "INFO - Selected: Upgrade to PG $version" > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
