...
echo 'INFO - @WatchTower Menu' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
...
A)
  if dialog --stdout --title "WatchTower Question" \
    ...
    echo 'INFO - Opted Not to make a WatchTower Selection' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
...
Z)
  ...
  if [ -e "$file" ]; then
     ...
     echo 'WARNING - User is Required to Select a WatchTower Preference' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
  fi ;;
esac
echo 'INFO - Looping: WatchTower Menu' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
bash /opt/plexguide/roles/watchtower/menus/main.sh
