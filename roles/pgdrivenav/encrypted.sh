...
#                ansible-role  services_remove
            ...
            if [ "$tcrypt" == "[tcrypt]" ]
              ...
              echo 'INFO - DEPLOYED TCRYPT' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
            fi
            ...
            if [ "$gcrypt" == "[gcrypt]" ]
              ...
              echo 'INFO - DEPLOYED GCRYPT' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
            fi
            ...
            echo 'INFO - DEPLOYED UNIONFS' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
