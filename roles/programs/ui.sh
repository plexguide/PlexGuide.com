...
echo 'INFO - @UI Programs Menu' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
...
case $CHOICE in
      ...
      A)
        echo 'INFO - Selected: HeimDall' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
        clear && ansible-playbook /opt/plexguide/pg.yml --tags heimdall --extra-vars "skipend=no"
        read -n 1 -s -r -p "Press any key to continue"
        ;;
      B)
      echo 'INFO - Selected: Muximux' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
      ...
      C)
          ...
          ;;
      D)
        echo 'INFO - Selected: Organizr' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
        clear && ansible-playbook /opt/plexguide/pg.yml --tags organizr --extra-vars "skipend=no"
        read -n 1 -s -r -p "Press any key to continue"
        ;;
        E)
        echo 'INFO - Selected: OrganizrV2' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log.sh
