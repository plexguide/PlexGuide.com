...
case $CHOICE in
        A)
            ...
            clear && ansible-playbook /opt/plexguide/pg.yml --tags alltube --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"

            ;;
        B)
            echo 'INFO - Selected: Monitorr' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
            clear && ansible-playbook /opt/plexguide/pg.yml --tags monitorr --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"
        ...
        D)
            ...
            clear && ansible-playbook /opt/plexguide/pg.yml --tags nowshowing --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"
            ;;
        E)
            echo 'INFO - Selected: Ombi' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
            clear && ansible-playbook /opt/plexguide/pg.yml --tags ombi --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"
            ;;
        F)
            echo 'INFO - Selected: Resilio' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
            clear && ansible-playbook /opt/plexguide/pg.yml --tags resilio --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"
            ;;
        G)
            echo 'INFO - Selected: Tautulli' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
            clear && ansible-playbook /opt/plexguide/pg.yml --tags tautulli --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"

            ;;
        H)
            echo 'INFO - Selected: The Lounge' > /var/plexguide/pg.log && bash /opt/plexguide/roles/log/log.sh
            clear && ansible-playbook /opt/plexguide/pg.yml --tags thelounge --extra-vars "skipend=no quescheck=yes"
            read -n 1 -s -r -p "Press any key to continue"
