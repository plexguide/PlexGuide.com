...
EOF
  ...
  file="/opt/appdata/plexguide/rclone.conf"
    if [ -e "$file" ]; then
      ...
      cat /opt/appdata/plexguide/rclone.conf | grep  -w tdrive -A 9 > /opt/appdata/plexguide/rclone.conf
      cat /opt/appdata/plexguide/rclone.conf | grep  -w gdrive -A 8 > /opt/appdata/plexguide/rclone.conf
      ...
      cat /opt/appdata/plexguide/rclone.conf >> /opt/appdata/plexguide/rclone.conf
      cat /opt/appdata/plexguide/rclone.conf >> /opt/appdata/plexguide/rclone.conf
    fi
