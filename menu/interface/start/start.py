...
def main():
    ...
    #command_item4 = CommandItem("Applicaiton Guard              " + appguard , "bash /opt/plexguide/roles/menu-appguard/scripts/main.sh && python3 /opt/plexguide/menu/interface/start/start.py && quit()")
    function_item = FunctionItem("Apple                         " + appguard , "rc = call('python3 /opt/plexguide/menu/interface/start/start.py && bash /opt/plexguide/roles/ending/ending.sh', shell=True)")
