...
with open('/var/plexguide/apip.check', 'r') as myfile:
    ...
    if apip == '':
        rc = call("echo 'Standby - Installing: PG Interface v0.0.3' && sleep 2 && echo && pip install git+git://github.com/Admin9705/plexguide-menu.git --disable-pip-version-check", shell=True)
