...
rollover_item2 = RolloverItem("Upload BW Limit : " + "speed" + " MB", "python3 /opt/plexguide/menu/interface/pgmove/speeds.py && python3 /opt/plexguide/menu/interface/pgmove/pgmove.py")
