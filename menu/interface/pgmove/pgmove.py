...
menu = ConsoleMenu("Welcome to PG Move!",
                   prologue_text=("PG Move is a simple uploader. It is highly recommend that you keep the BW @ 9MB; equaling 750GB per day over a period of 24 hours! If uploading less than 750GB per day, user can increase the speeds! Making Changes? Redeploy PG Move!"))
...
if configure == '[Encrypted]':
    rollover_item3 = RolloverItem("Deploy PG Move  : Encrypted /w PG Drives", "ansible-playbook /opt/plexguide/roles/menu-move/remove-service.yml && ansible-playbook /opt/plexguide/pg.yml --tags menu-move && python3 /opt/plexguide/menu/interface/pgmove/pgmove.py")
