...
if configure == '[GDrive]':
    rollover_item3 = RolloverItem("Deploy Drives   : Google Drive", "ansible-playbook /opt/plexguide/roles/menu-move/remove-service.yml && ansible-playbook /opt/plexguide/pg.yml --tags menu-pgdrives && python3 /opt/plexguide/menu/interface/pgdrives/pgdrives.py")
elif configure == '[GDrive /w TeamDrive]':
    rollover_item3 = RolloverItem("Deploy Drives   : Google Drive /w TeamDrives", "ansible-playbook /opt/plexguide/roles/menu-move/remove-service.yml && ansible-playbook /opt/plexguide/pg.yml --tags menu-pgdrives && python3 /opt/plexguide/menu/interface/pgdrives/pgdrives.py")
else:
