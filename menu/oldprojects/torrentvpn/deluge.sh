...
bash /opt/plexguide/menu/scripts/torrentvpn/vpnowners.sh
# create and move openvpn setup files to vpn directory
bash /opt/plexguide/menu/scripts/torrentvpn/openvpn-setup-deluge.sh
...
#bash /opt/plexguide/menu/scripts/torrentvpn/move-ovpnd.sh
#yes | apt-get install -y python-setuptools 1>/dev/null 2>&1
#python /opt/plexguide/menu/scripts/tasks/seedtime/setup.py bdist_egg
#mv /opt/plexguide/menu/scripts/tasks/seedtime/dist/SeedTime-2* /opt/appdata/vpn/config/plugins
clear
