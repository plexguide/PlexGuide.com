...
#
#################################################################################
echo 'INFO - @Backup-Restore Main Menu' > /var/plexguide/pg.log && bash /opt/plexguide/menu/log/log.sh
...
case $CHOICE in
        A)
echo 'INFO - Selected: Deploy a New WP Server' > /var/plexguide/pg.log && bash /opt/plexguide/menu/log/log.sh
            bash /opt/plexguide/menus/wordpress/deploywp.sh 
            ;;
        B)
echo 'INFO - Selected: Backup a WP Server' > /var/plexguide/pg.log && bash /opt/plexguide/menu/log/log.sh
            bash /opt/plexguide/menus/wordpress/backup.sh 
            ;;
        C)
echo 'INFO - Selected: Restore a WP Server' > /var/plexguide/pg.log && bash /opt/plexguide/menu/log/log.sh
