...
@click.version_option('1.2.5', prog_name='Rush')
@click.option(
    '--config',
    envvar='RUSH_CONFIG',
...
@app.command(help='Authenticate Rush.')
...
@app.command(help='Run Rush in automatic mode.')
@click.option(
    '--add-delay', '-d',
    default=2.5,
...
if __name__ == "__main__":
    ...
    print(f.renderText('Rush'))

    print("""
Welcome to RUSH - PlexGuide.com
""")
