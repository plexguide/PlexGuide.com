...
whiptail --title "Donation Option Info" --msgbox "Would you be kind enough to TURN ON the Donation Option to mine for coins? From here, you can also disable/stop the mining of coins" 13 78
...
if (whiptail --title "PlexGuide Donation Selection" --yesno "Will you Donate your Unused CPU Power to Assist Us?" 8 78) then
    ...
    whiptail --title "Donation Status - No" --msgbox "We understand! If installed or running prior, we will disable it!" 9 74
