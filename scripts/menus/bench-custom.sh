#! /bin/bash
whiptail --title "Information" --msgbox "This is a custom benchmarking and speedtest script for your machine. From here you can manipulate which options you want to include in the test! You can return anytime by pressing Cancel. Navigate using Space, TAB and Up/Down Arrow keys. Choose OK to continue." 20 12
