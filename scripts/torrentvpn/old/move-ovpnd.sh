...
`mv /opt/appdata/vpn/deluge/config/Remotes/ca.rsa.2048.crt /opt/appdata/vpn/deluge/config/openvpn/`
`mv /opt/appdata/vpn/deluge/config/Remotes/crl.rsa.2048.pem /opt/appdata/vpn/deluge/config/openvpn/`
...
`mv /opt/appdata/vpn/deluge/config/Remotes/Netherlands.ovpn /opt/appdata/vpn/deluge/config/openvpn/`
