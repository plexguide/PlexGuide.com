...
`mv /opt/appdata/vpn/rtorrent/config/Remotes/ca.rsa.2048.crt /opt/appdata/vpn/rtorrent/config/openvpn/`
`mv /opt/appdata/vpn/rtorrent/config/Remotes/crl.rsa.2048.pem /opt/appdata/vpn/rtorrent/config/openvpn/`
...
`mv /opt/appdata/vpn/rtorrent/config/Remotes/Netherlands.ovpn /opt/appdata/vpn/rtorrent/config/openvpn/`
